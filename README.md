...
# Onboarding Funnel Intelligence

![Demo Screenshot](demo/screenshot.png)

## Overview
Track activation funnel drop-off, isolate friction points, and rank onboarding opportunities.
...
- Tags: activation, funnel, analytics
